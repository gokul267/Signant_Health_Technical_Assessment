...
#Test update user information for given user name with empty values
def test_put_userInfo_emptyValues():
    ...
    request_data = json.loads(updateUserData2);
    ...
    assert updateUserInfo.get_response_statuscode()  == 201, 'API call failed'
